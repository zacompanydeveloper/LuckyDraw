<template>
    ...
    <header class="w-full flex justify-between items-center shadow-xl py-2 px-10">
        <div>
            <Drawer v-model:visible="visible" header="Lucky Draw App" :show-close-icon="false"
                class="rounded-e-lg" style="color: #2E3192;">
                <ul class="flex flex-col gap-1">
                    <li>
                        <router-link
                            to="/admin-panel"
                            active-class="font-semibold bg-[#2E3192]/10"
                    ...
                    <li>
                        <router-link
                            to="/admin-panel/code-registration"
                            active-class="font-semibold bg-[#2E3192]/10"
                            class="w-full block text-[#2E3192] hover:bg-[#2E3192]/10 px-3 py-2 rounded-md transition-colors"
                        >
