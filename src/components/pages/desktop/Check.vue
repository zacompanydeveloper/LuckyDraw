<template>
    <DesktopLayout>
        <div>
            ...
            <!-- Content -->
            <div class="grid grid-cols-2 justify-center p-5">

                <!-- Image -->
                <div class=" mx-auto my-auto">
                    <img src="@/assets/images/activate.png" alt="Activate Image" class=" w-90 object-cover rounded-lg">
                </div>
                ...
                <div class=" flex w-full justify-center">
                    ...
                    <!-- Form -->
                    <div class="flex flex-col w-[60%] gap-4 pt-1">
                        ...
                        <!-- Date -->
                        <div class="flex text-gray-500 w-full" v-if="checked && checkedWarranty?.status != 'pending'">
